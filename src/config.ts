...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: "assets/images/banner-5.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
    position: "center",                // Equivalent to object-position, only supports 'top', 'center', 'bottom'. 'center' by default
    credit: {
      enable: true,                             // Display the credit text of the banner image
      text: "About",   // Credit text to be displayed
      url: "https://ai.qubitpi.org/about/" // (Optional) URL link to the original artwork or artist's page
    }
  },
  topBlog: "Machine Learning", // The "title" field of the blog front matter
  toc: {
...
export const profileConfig: ProfileConfig = {
  ...
  name: "Jiaqi Liu",
  bio: "The Future is a game between AI's Determinism and Human's Libertarianism",
  links: [
    {
      name: 'Hugging Face',
